 ...
 */
#ifndef LIGHTGBM_TREELEARNER_COST_EFFECTIVE_GRADIENT_BOOSTING2_HPP_
#define LIGHTGBM_TREELEARNER_COST_EFFECTIVE_GRADIENT_BOOSTING2_HPP_
...
class CostEfficientGradientBoosting2 {
 public:
  explicit CostEfficientGradientBoosting2(const SerialTreeLearner2* tree_learner):tree_learner_(tree_learner) {
  }
 ...
 private:
  ...
  const SerialTreeLearner2* tree_learner_;
